...
class editClub extends StatefulWidget {
  ...
  editClub(this.club);
  @override
  _editClub createState() => _editClub();
}

class _editClub extends State<editClub> {
  //input controllers
  ...
  Future<dynamic> SignUp(
    ...
    String clubId = widget.club['_id'];

    var stream =
        new http.ByteStream(DelegatingStream.typed(imageFile.openRead()));
    var length = await imageFile.length();
    var uri =
        Uri.parse("http://192.168.194.123:3000/api/admin/" + clubId + "/clubs");
